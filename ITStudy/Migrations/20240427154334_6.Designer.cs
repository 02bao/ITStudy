...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITStudy.Models.Favorite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ITStudy.Models.Notifications", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("StatusNoti")
                        .HasColumnType("integer");

                    b.Property<int>("StatusSent")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ITStudy.Models.Reviews", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ITStudy.Models.CartItem", b =>
                {
                    b.HasOne("ITStudy.Models.BuyCourses", "BuyCourse")
                        .WithMany("List_CartItems")
                        .HasForeignKey("BuyCourseId");
            ...
            modelBuilder.Entity("ITStudy.Models.Notifications", b =>
                {
                    ...
                    b.HasOne("ITStudy.Models.Favorite", "Favorite")
                        .WithMany()
                        .HasForeignKey("FavoriteId");

                    b.HasOne("ITStudy.Models.Lectures", "Lecture")
                        .WithMany()
                        .HasForeignKey("LectureId");

                    b.HasOne("ITStudy.Models.Posts", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("ITStudy.Models.Reviews", b =>
                {
                    b.HasOne("ITStudy.Models.CartItem", "CartItem")
                        .WithMany()
